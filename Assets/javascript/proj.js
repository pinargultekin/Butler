...
var queryURL = `https://api.edamam.com/search?q=chicken&app_id=cd0febb4&app_key=6d1400c54461c5fb357e208675e77e00&from=0&to=3&calories=591-722&health=alcohol-free`;
$.ajax({
  url: queryURL,
  method: "GET"
}).then(function(response) {
  $("#foodData").text(JSON.stringify(response));
});
